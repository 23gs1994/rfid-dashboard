...
def update_visuals_for_Tag(start_date, end_date):
    ...
    kpi_blocks = [
        ...
        html.Div([html.H6("Peak cpu_usage"), html.H4(f"{peak_cpu_value}%, {peak_cpu_value_date}, {peak_cpu_value_weekday}, {peak_cpu_value_start_hour}-{peak_cpu_value_end_hour}")], style={**kpi_card_style, "backgroundColor": "#f8f9fa"}),
        html.Div([html.H6("Peak memory_usage"), html.H4(f"{peak_memory_value}MB, {peak_memory_value_date}, {peak_memory_value_weekday}, {peak_memory_value_start_hour}-{peak_memory_value_end_hour}")], style={**kpi_card_style, "backgroundColor": "#f8f9fa"}),
        html.Div([html.H6("Peak disk_usage"), html.H4(f"{peak_disk_value}%, {peak_disk_value_date}, {peak_disk_value_weekday}, {peak_disk_value_start_hour}-{peak_disk_value_end_hour}")], style={**kpi_card_style, "backgroundColor": "#f8f9fa"}),
        html.Div([html.H6("Peak temperature"), html.H4(f"{peak_temperature_value} C, {peak_temperature_value_date}, {peak_temperature_value_weekday}, {peak_temperature_value_start_hour}-{peak_temperature_value_end_hour}")], style={**kpi_card_style, "backgroundColor": "#f8f9fa"}),
